        ...
        >
          ...
          >
            ...
            <div>
              ...
              {/* Social Icons (Instagram, LinkedIn, X/Twitter, Facebook, WhatsApp) */}
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                ...
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/people/Sanitix-Technologies/61594983111252/"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Facebook"
                  style={{
          ...
          >
            © 2026 Sanitix Technologies Private Limited (A Pairow Group Company). All rights reserved.
          </div>
        </div>
      </div>
          ...
          >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '18px', fontSize: '13px', lineHeight: 1.65, color: '#D1D5DB' }}>
                  <div>
                    ...
                    <p style={{ margin: 0, color: '#9CA3AF' }}>
                      At Sanitix Technologies Private Limited (&quot;Sanitix&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), we respect and uphold your confidentiality. This Privacy Policy details how we collect, handle, store, and safeguard your personal data when you interact with our website, mobile application, and utility booking platforms.
                    </p>
                  </div>
            ...
            {activeModal === 'terms' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div>
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '4px 12px', backgroundColor: 'rgba(16, 185, 129, 0.12)', border: '1px solid rgba(16, 185, 129, 0.25)', borderRadius: '9999px', fontSize: '11px', fontWeight: 600, color: '#10B981', marginBottom: '8px' }}>
                    Sanitix Technologies Private Limited (A Pairow Group Company)
                  </div>
                  <h3 style={{ fontSize: '22px', fontWeight: 800, color: '#FFFFFF', margin: 0 }}>
                    Terms & Conditions
                  </h3>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '18px', fontSize: '13px', lineHeight: 1.65, color: '#D1D5DB' }}>
                  ...
                  <div>
                    ...
                    <p style={{ margin: 0, color: '#9CA3AF' }}>
                      While Sanitix enforces strict delivery SLAs and quality controls, Sanitix Technologies Private Limited shall not be held liable for indirect delays resulting from force majeure conditions, including unforeseen road closures, extreme weather calamities, municipal water grid rationing, or civil traffic restrictions.
                    </p>
                  </div>
